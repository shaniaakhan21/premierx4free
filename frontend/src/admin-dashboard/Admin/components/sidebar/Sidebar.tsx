  ...
  return (
    <div className={classes.sidebar_mainContainer}>
      ...
      <div className={classes.sidebar_navigation}>
        <Link className={classes.navigation_li} to='/admin'>
          <img src='/assets/svg/documents.svg' className={classes.navigation_img} />
          <p>Agent Documents</p>
        </Link>
        <Link className={classes.navigation_li} to='/admin/calculation'>
          <img src='/assets/svg/calculator.svg' className={classes.navigation_img} />
          <p>Calculation Page</p>
        </Link>
        <Link className={classes.navigation_li} to='/admin/agents'>
          <img src='/assets/svg/calculator.svg' className={classes.navigation_img} />
          <p>Agent Search</p>
        </Link>
        <Link className={classes.navigation_li} to='/admin/marketingMaterials'>
          <img src='/assets/svg/marketing.svg' className={classes.navigation_img} />
          <p>Marketing Materials</p>
        </Link>
        <Link className={classes.navigation_li} to='/admin/settings'>
