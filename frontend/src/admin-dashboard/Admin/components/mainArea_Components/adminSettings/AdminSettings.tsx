                    ...
                    <div className='form-box-firstPart'>
                        <div className='form-box-field'>
                            <Form.Group controlId="fullName">
                                ...
                                <Form.Control type="text" defaultValue='Heather Stephens' className='form-box-inputArea' name='name' value={state.name} onChange={onChange} />
                            </Form.Group>
                        </div>
                        <div className='form-box-field'>
                            <Form.Group controlId="email">
                                <Form.Label className='form-box-lable1'>Email Address</Form.Label>
                                <Form.Control type="email" defaultValue='heatherstephens@gmail.com' className='form-box-inputArea' name='email' value={state.email} onChange={onChange} />
                            </Form.Group>
                        </div>
                        ...
                        <div className='form-box-field'>
                            <Form.Group controlId="phone">
                                ...
                                <Form.Control type="tel" defaultValue='9987665945' className='form-box-inputArea' name='contactNo' value={state.contactNo} onChange={onChange} />
                            </Form.Group>
                        </div>
                        <div className='form-box-field'>
                            <Form.Group controlId="zip">
                                <Form.Label className='form-box-lable1'>Zip Code</Form.Label>
                                <Form.Control type="text" defaultValue='56690' className='form-box-inputArea' name='zip' value={state.zip} onChange={onChange} />
                            </Form.Group>
                        </div>
                    </div>
                    ...
                    <div className='horizontalLine'>
                        ...
                        <div className='form-box-field-top'>
                            <Form.Group controlId="currentPassword">
                                ...
                                <Form.Control type="password" defaultValue='abc@123' className='form-box-inputArea' name='password' value={state.password} onChange={onChange} />
                            </Form.Group>
                        </div>
                        ...
                        <div className='form-box-field'>
                            <Form.Group controlId="newPassword">
                                ...
                                <Form.Control type="password" defaultValue='abcd@123' className='form-box-inputArea' name='newPassword' value={state.newPassword} onChange={onChange} />
                            </Form.Group>
                        </div>
                        <div className='form-box-field'>
                            <Form.Group controlId="confirmNewPassword">
                                <Form.Label className='form-box-lable2'>Confirm Password</Form.Label>
                                <Form.Control type="password" defaultValue='abcd@123' className='form-box-inputArea' name='confirm' value={state.confirm} onChange={onChange} />
                            </Form.Group>
                        </div>
                    </div>
