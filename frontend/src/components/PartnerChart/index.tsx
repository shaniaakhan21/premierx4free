  ...
  return (
    <div className={classes.container}>
      <div className={classes.row}>
        <div id="quarter1" className={classes.quarter1} onMouseEnter={(e) => onImageHovered(e, 0)}
        ...
        <div id="quarter2" className={classes.quarter2} onMouseEnter={(e) => onImageHovered(e, 1)}
             onMouseLeave={onHoverEnd}>
      ...
      <div className={classes.row}>
        <div id="quarter3" className={classes.quarter3} onMouseEnter={(e) => onImageHovered(e, 2)}
             onMouseLeave={onHoverEnd}>
          <img src={swiftMD} className={classes.ellipseImg} />
          <img src={swiftMDIcon} className={`icon ${classes.icon3}`} />
        </div>
        <div id="quarter4" className={classes.quarter4} onMouseEnter={(e) => onImageHovered(e, 3)}
             onMouseLeave={onHoverEnd}>
