...
function BMAInfo(): JSX.Element {
  ...
  return (
    <Grid container className={classes.container}>
      <Box style={{ position: 'absolute', height: 20, backgroundColor: '#0556A7', width: '100%', zIndex: 1 }} />
        ...
        <Box className={classes.bmaContainer}>
          ...
          <div className={classes.textSeparator}>
            <Typography className={classes.bmaText}>
              ...
              distribution. Our services do not stop here. Learn more about our Prescription Benefit Program that can
              help anyone and everyone {'(to save money and have better services)'}
            </Typography>
          </div>
        </Box>
      </Grid>
        ...
        <Box className={classes.infoContainer}>
          ...
          <div className={classes.textSeparator}>
            <Typography className={classes.infoText}>
              The power of healthcare cutting-edge advancements and mass distribution thereof, have always worked
              hand-in-hand toward the rapid delivery, impact, and enrichment of the of American lives.
            </Typography>
            <Typography className={classes.infoText}>
              What we do is Bridge the Gap between our Partners innovative advancements, our National Distribution
              Marketers and everyday American’s.
            </Typography>
          </div>
        </Box>
      </Grid>
