        ...
        descriptionVisible && (
          <div className={classes.partnerDescription}>
            ...
            <Typography className={classes.infoText}>
              ...
              and patients with customized, compound medications. We're here to better your health, together.
            </Typography>
          </div>
        )
      }
        ...
        descriptionVisible && (
          <div className={classes.partnerDescription}>
            ...
            <Typography className={classes.infoText}>
              ...
              distribution. Our services do not stop here. Learn more about our Prescription Benefit Program that can help
              anyone and everyone {`(to save money and have better services)`}
            </Typography>
      ...
      </Typography>
      {
        descriptionVisible && (
          <div className={classes.partnerDescription}>
            ...
            <Typography className={classes.infoText}>
              We are leading the modernisation of routine medical care for patients and reducing costs for our
              clients.Here are four ways SwiftMD is different from other platforms.
            </Typography>
            ...
            <Typography className={classes.infoText}>
              We select the best doctors who are passionate about online healthcare services. They work exclusively with
              us in telemedicine, and they develop relationships with our members through repeat virtual doctor visits.
            </Typography>
          </div>
        )
      }
