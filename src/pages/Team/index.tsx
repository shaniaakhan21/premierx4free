...
const people = [
  ...
  {name: 'David Whitmarsh - Special Advisor', marginTop:17, imageSrc: '/assets/svg/Team/david.svg' , description:'David spent 14 years with H David spent 14 years with HR.com serving as the VP of Sales and then the VP of Research & Revenue. HR.com is the largest social network and online community of Human Resource executives trusted by more than 1 million HR professionals worldwide. 6 years of marketing consulting with a variety of HR service providers.'},
