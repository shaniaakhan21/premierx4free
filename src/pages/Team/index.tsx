...
const people = [
  ...
  { name: 'Tomás P. Quevedo', imageSrc: '/assets/images/Team/Ellipse4.png' , description:'Tomas Perez-Quevedo is a Peruvian-born innovator and a performance-driven Entrepreneur in the technology sector. Tomas is a very successful Investor with a global company that has been expanding and working within the industry for the past 15 years. As a founder and managing president of TPQ Global Business, he has partnered with many companies in the areas of technology and software development. Additionally he has vast knowledge and extensive experience in agriculture and health driven products. His investing style of discipline, patience and value has consistently outperformed the market for decades.'},
];
