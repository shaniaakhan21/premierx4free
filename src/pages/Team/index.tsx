...
const people = [
  ...
  {name: 'Marks Peters - COO', marginTop:47, imageSrc: '/assets/svg/Team/mark.svg', description:'Mark specializes in finance and has an MBA in investment finance from SCU Leavey School of Business. He has spent his career working for insurance and fintech companies. Mark designed and developed NSUR’s Value Protection Program along with NSUR’s insurance and crypto legal advisors. Over the last 15 years, Mark has raised over $250M in debt and equity investments for his companies. Mark has brought his company investors many positive outcomes, including taking Vocera Communications public in 2012, and has over $1.3B in acquisition exits over the last 4 years, yielding an average multiple return of 5x. Mark is also well versed in public company finance and building strategic partnerships.' },
  {name: 'David Whitmarsh - Special Advisor', marginTop:17, imageSrc: '/assets/svg/Team/david.svg' , description:'David spent 14 years with H David spent 14 years with HR.com serving as the VP of Sales and then the VP of Research & Revenue. HR.com is the largest social network and online community of Human Resource executives trusted by more then 1 million HR professionals worldwide. 6 years of marketing consulting with a variety of HR service providers. R.com serving as the VP of Sales and then the VP of Research & Revenue. HR.com is the largest social network and online community of Human Resource executives trusted by more then 1 million HR professionals worldwide. 6 years of marketing consulting with a variety of HR service providers.'},
  {name: 'Tomás P. Quevedo - CTO', marginTop:47,imageSrc: '/assets/svg/Team/tomas2.png' , description:'Tomas Perez-Quevedo is a Peruvian-born innovator and a performance-driven Entrepreneur in the technology sector. Tomas is a very successful Investor with a global company that has been expanding and working within the industry for the past 15 years. As a founder and managing president of TPQ Global Business, he has partnered with many companies in the areas of technology and software development. Additionally he has vast knowledge and extensive experience in agriculture and health driven products. His investing style of discipline, patience and value has consistently outperformed the market for decades.'},
